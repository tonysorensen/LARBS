...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/tonysorensen/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/tonysorensen/LARBS/master/progs.csv"
